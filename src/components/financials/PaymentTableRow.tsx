...
interface PaymentTableRowProps {
  payment: any;
  onApprove: (paymentId: string, approved: boolean) => void;
}

const PaymentTableRow = ({ payment, onApprove }: PaymentTableRowProps) => {
  return (
        ...
        {payment.status === 'pending' && (
          <div className="flex gap-2">
            <Button
              ...
              onClick={() => onApprove(payment.id, true)}
            >
            ...
            <Button
              ...
              onClick={() => onApprove(payment.id, false)}
            >
              <X className="h-4 w-4" />
            </Button>
          </div>
